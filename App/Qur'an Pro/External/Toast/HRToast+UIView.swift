...
extension UIView {
    ...
    */
    ...
    @objc func makeToastActivityWithMessage(message msg: String){
        self.makeToastActivity(position: HRToastActivityPositionDefault as AnyObject, message: msg)
    }
    
    @objc func makeToastActivity(position pos: AnyObject, message msg: String = "") {
    ...
    */
    @objc func hideToast(toast: UIView) {
        self.hideToast(toast: toast, force: false);
    }
    
    @objc func hideToast(toast: UIView, force: Bool) {
    ...
    @objc func centerPointForPosition(_ position: AnyObject, toast: UIView) -> CGPoint {
    ...
    @objc func viewForMessage(_ msg: String?, title: String?, image: UIImage?) -> UIView? {
