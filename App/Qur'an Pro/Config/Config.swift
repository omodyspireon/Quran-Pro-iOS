...
let isDebug: Bool = ProcessInfo.processInfo.environment["DEBUG"] != nil
let isIpad: Bool = UIDevice.current.userInterfaceIdiom == .pad
let isPortrait: Bool = UIDevice.current.orientation == UIDeviceOrientation.portrait || UIDevice.current.orientation == UIDeviceOrientation.portraitUpsideDown

// Constants
let kQuranProId = "1203492063"
let kQuranLiteId = "1203492063"
let kQuranLiteName = "Memorize Lite"
let kAppDefaultLanguage: String = "en"
let kApplicationDisplayName: String = isPro ? (Bundle.main.localizedInfoDictionary?["CFBundleLargeDisplayName"] as? String)! : kQuranLiteName
let kApplicationVersion: NSString = (Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? NSString)!
let kApplicationName: NSString = (Bundle.main.infoDictionary?["CFBundleName"] as? NSString)!
let kAppId: String = isPro ? kQuranProId : kQuranLiteId
let kDevEmail: String  = "omarmody@gmail.com"
...
let kMoreAppsUrl: String = "itms-apps://itunes.com/apps/omarmody"
...
let kSpecialReciterFolderFormatIds = [6, 7, 8]
...
// NavigationBar
let kUINavigationBarTintColor: UIColor = UIColor.white
...
let kABRepeatFile: String = "abrepeat"
...
let kCurrentSpeedVerseKey: String = "currentSpeedAya"
...
// ABRepeat
let kABRpeatChangedNotification: String = "ABRepeatChangedNotification"
let kABRepeatRemovedNotification: String = "ABRepeatRemovedNotification"
...
// Speed count changed
let kSpeedCountChangeNotification: String = "SpeedCountChangedNotfication"
